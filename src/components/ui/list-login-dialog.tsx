...
export default function ListLoginDialog() {
  ...
  return (
    <Dialog>
      <DialogTrigger className="w-full mt-3" asChild>
        <Button className="w-full">{t("ListLoginDialog.button")}</Button>
      </DialogTrigger>
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          {" "}
          <DialogTitle>{t("ListLoginDialog.title")}</DialogTitle>
          <DialogDescription>
            {t("ListLoginDialog.description")}
          </DialogDescription>
        </DialogHeader>
        <Button
          className="py-5"
