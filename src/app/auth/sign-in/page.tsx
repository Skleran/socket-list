...
export default function SignIn() {
  ...
  return (
    <div className="flex flex-col items-center justify-between gap-6 font-mono py-24 text-center">
      <div className="bg-accent-foreground text-accent py-1.5 px-3 rounded-4xl">
        {/* <p className="">one list, everyone&#8217;s updates</p> */}
        <p className="">shared lists, made simple</p>
      </div>
      <h1 className="scroll-m-20 text-3xl font-semibold tracking-tight first:mt-0 mb-2 sm:mb-3 sm:text-5xl">
        Lists shouldn&#8217;t be lonely.
        <br /> Share yours with anyone instantly.
      </h1>
      <div className="w-full px-10 flex flex-col gap-3">
        <p className="text-muted-foreground">Make a list, send the link.</p>
        <div className="w-full flex justify-center items-center flex-col sm:flex-row gap-3">
          <Button
            className="py-5 sm:w-[40%]"
            onClick={() => {
          ...
          <p className="hidden sm:inline">or</p>
          <Button
            className="py-5 sm:w-[40%]"
            onClick={() => {
